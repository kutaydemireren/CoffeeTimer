...
extension BrewQueue {
    static var stubMini: BrewQueue {
        BrewQueue(stages: [
            .init(action: .putCoffee(.init(amount: 10, type: .gram)), requirement: .none, startMethod: .userInteractive, passMethod: .userInteractive, message: "Put all your 10.0 grams of coffee to brewer"),
            ...
            .init(action: .pourWater(.init(amount: 40, type: .millilitre)), requirement: .none, startMethod: .auto, passMethod: .userInteractive, message: "To bloom, pour 40.0 millilitres of water\nTotal: 80.0 millilitres of water")
        ])
    }
}
